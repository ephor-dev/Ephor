...
class ImpactAssessmentStartView extends StatelessWidget {
  final ImpactAssessmentViewModel viewModel;

  const ImpactAssessmentStartView({
    super.key,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // 3. Description
              Text(
                "You are about to start a Impact Assessment. Please ensure you have a stable internet connection and fill all that which applies.",
              ...
              _buildDetailRow(context, Icons.person_2_outlined, "Identity", "Fill Personal Details of Employee"),
              const SizedBox(height: 12),
              _buildDetailRow(context, Icons.handyman_outlined, "Assessment", "Assess Employee after Training."),
