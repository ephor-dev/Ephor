...
/// ViewModel for CATNA Form 1 (Identifying Data).
///
/// Manages all form state (controllers, dropdowns, dates) and handles
/// restoration from the shared view model when navigating back.
class CatnaForm1ViewModel extends ChangeNotifier {
  final CatnaFormSharedViewModel _sharedViewModel;
  ...
  CatnaForm1ViewModel({required CatnaFormSharedViewModel sharedViewModel})
  ...
  void _restoreFromShared() {
    final saved = _sharedViewModel.identifyingData;
