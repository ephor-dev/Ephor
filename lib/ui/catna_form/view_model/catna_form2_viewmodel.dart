...
/// ViewModel for CATNA Form 2 (Rating of Competency).
///
/// Manages all assessment ratings and handles restoration from the shared
/// view model when navigating back.
class CatnaForm2ViewModel extends ChangeNotifier {
  ...
  CatnaForm2ViewModel({required CatnaFormSharedViewModel sharedViewModel})
  ...
  void _restoreFromShared() {
    final saved = _sharedViewModel.competencyRatings;
